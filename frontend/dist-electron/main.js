import require$$3$1, { app, BrowserWindow } from 'electron';
...
const squirrelStartup = /* @__PURE__ */ getDefaultExportFromCjs(
...
const createWindow = () => {
  const mainWindow = new BrowserWindow({
    ...
    height: 800,
    webPreferences: {
      // Usamos nuestra nueva variable __dirname
